insert into STUDENT (ID, FIRST_NAME, LAST_NAME, USERNAME) values (null, 'Eddie', 'Ekpo', 'eekpo');
insert into STUDENT (ID, FIRST_NAME, LAST_NAME, USERNAME) values (null, 'Edwin', 'Hernandez', 'ehernandez');
insert into STUDENT (ID, FIRST_NAME, LAST_NAME, USERNAME) values (null, 'Nicholas', 'Kalar', 'nkalar');
...
INSERT INTO COURSE(ID, NAME, SECTION, current, last, LOCATION, UPDATED, INSTRUCTOR)
VALUES ( null, 'CMPS 4910', '01', CURRENT_DATE, CURRENT_DATE , 'https://cs.csub.edu/~clei/teaching/19F4910.html', true, 1);


-- INSERT INTO Student (first_name, last_name, username, studentPassword) VALUES ("Nicholas", "Kalar", "nkalar");
-- INSERT INTO Student (first_name, last_name, username, studentPassword) VALUES ("Eddie", "Ekpo", "eekpo", "password1");
-- INSERT INTO Student (first_name, last_name, username, studentPassword) VALUES ("Ewdin", "Hernanadez", "ehernanadez");

-- Hibernate: create table admin (id bigint generated by default as identity, first_name varchar(255), last_name varchar(255), school_id bigint, username varchar(255), primary key (id))
-- Hibernate: create table authorities (username varchar(255) not null, authority varchar(255) not null, primary key (username))
-- Hibernate: create table course (id bigint generated by default as identity, name varchar(255), section varchar(255), last_update date, location varchar(255), updated boolean not null, instructor bigint, primary key (id))
